...
import {
    AUTHORIZED_OBJECT3D_EXTENSIONS,
    AUTHORIZED_VIDEOS_EXTENSIONS,
    ee,
    EVENT_HIDE_LOADING,
    EVENT_SHOW_LOADING, initObjects3DLibrary,
    initVideosLibrary
} from "../utils/library";
        ...
        request('https://www.google.com', {timeout: 10000})
                    ...
                    progress(request(pictureUrl, {timeout: 30000}))
                        ...
                        .on('end', () => {
                            ...
                            fileType.fromBuffer(buffer).then(type => {
                                if (type !== undefined && AUTHORIZED_OBJECT3D_EXTENSIONS.indexOf(`.${type.ext}`) !== -1) {
            ...
            Promise.all(
                ...
                .then(results => {
                    ...
                    initObjects3DLibrary(successfullyDownload, [this.props.parentFolder], this.props.pictures).then(objects3DObjects => {
                        // Add new pictures to lib.
                        this.props.refreshState(objects3DObjects);
                ...
                console.log('There was some error downloading 3D models.');
                console.error(err)
            });
        });
    };
    ...
    render() {
        ...
        return (
            <fieldset className="import-fieldset">
                <legend className="import-legend">Import remote 3D objects</legend>
