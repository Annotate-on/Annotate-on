...
class EventForm extends Component {
    ...
    _submitEventEditForm = () => {
        ...
        if (this.getEventDuration() === 0){
            alert(t('event.alert_please_enter_event_duration'));
            return false;
        }else{
    ...
    _createNewEvent = (startNow) => {
        ...
        if(this.state.eventName.length === 0 || this.state.eventDuration === 0){
            alert(t('event.alert_please_enter_event_name_and_duration'));
            return false;
        }
        ...
        if (this._isEventNameAlreadyTaken(EVENT_PATH)){
            alert(t('event.alert_event_already_exists_in_this_folder', { eventName: this.state.eventName}));
            return false;
        }
            ...
            <div className={this.props.isCreateMode ? "event-form" : "event-form event-form-edit-mode"}>
                {
                    this.props.event !== null && this.props.isCreateMode === false && this.props.event.status === EVENT_STATUS_FINISHED ?
                        <h5 className="event-header-text">{t('event.lbl_event_edition')}</h5> : null
                }
                    ...
                    this.props.event !== null && this.props.isCreateMode === false && this.props.event.status === EVENT_STATUS_FINISHED ?
                                ...
                                <Row className="date-option-row">
                                    ...
                                    <Col sm={2} md={2} lg={2}>
                                        <FormGroup className="fg-display-flex">
                                            ...
                                            <label><p>{t('event.lbl_hour_abbr')}</p></label>
                                        </FormGroup>
                                    </Col>
                                    <Col sm={2} md={2} lg={2}>
                                        <FormGroup className="fg-display-flex">
                                            ...
                                            <label><p>{t('event.lbl_minute_abbr')}</p></label>
                                        </FormGroup>
                                    </Col>
                                    <Col sm={2} md={2} lg={2}>
                                        <FormGroup className="fg-display-flex">
                                            ...
                                            <label><p>{t('event.lbl_second_abbr')}</p></label>
                                        </FormGroup>
                                    </Col>
                                </Row>
                            </div>
                        ...
                        <div>
                            <div className="event-form-item">
                                <Row>
                                    ...
                                    <Col sm={3} md={3} lg={3} className="advanced-options-title">
                                        ...
                                        >{t('event.btn_advanced_options')}</Button>
                                    </Col>
                                    <Col sm={6} md={6} lg={6}/>
                                </Row>
                            </div>
                            ...
                            <div className="event-form-item">
                                <Row className="date-option-row">
                                    <Col sm={3} md={3} lg={3}  className="event-form-field-label">
                                        {t('event.lbl_maximum_event_duration')}:
                                    </Col>
                                    <Col sm={3} md={3} lg={3}>
                                        <Input type="select" name="duration_sl" id="duration_sl" value={this.state.eventMaxDuration} onChange={ (event) => this.handleEventTimeChange(event)}>
                                            <option>{''}</option>
                                            <option value="3600">1{t('event.lbl_hour_abbr')}</option>
                                            <option value="7200">2{t('event.lbl_hour_abbr')}</option>
                                            <option value="10800">3{t('event.lbl_hour_abbr')}</option>
                                        </Input>
                                    </Col>
                                    <Col sm={1} md={1} lg={1}>
                                        <p>{t('event.lbl_or')}</p>
                            ...
                            <div className="event-form-item">
                                <Row>
                                    <Col sm={3} md={3} lg={3}  className="event-form-field-label">
                                        {t('event.lbl_automatic_time_extension')}:
                                    </Col>
                                    <Col sm={3} md={3} lg={3}>
                                        <Input type="select" name="duration_ex" id="duration_ex" value={this.state.eventTimeExtension} onChange={ event => this.handleEventTimeExtensionChange(event)}>
                                            <option value="1800">+30{t('event.lbl_minute_long_abbr')}</option>
                                            <option value="3600">+1{t('event.lbl_hour_abbr')}</option>
                                            <option value="7200">+2{t('event.lbl_hour_abbr')}</option>
                                            <option value="0">{t('event.lbl_none')}</option>
                                        </Input>
                                    </Col>
                                    <Col sm={6} md={6} lg={6}/>
                                </Row>
                        ...
                        <div className="event-form-item">
                            <Row>
                                ...
                                <Col sm={3} md={3} lg={3}>
                                    ...
                                    >{t('event.btn_start_event_now')}</Button>
                                </Col>
                                <Col sm={6} md={6} lg={6}/>
                            </Row>
                        </div> : null
                ...
                <Row className="ef-action-buttons">
                    ...
                    <Col sm={9} md={9} lg={9}>
                        ...
                        }}>{this.props.isCreateMode ? t('event.btn_create_new_event') : t('event.btn_save_changes')}
                        </Button>
                        <Button
