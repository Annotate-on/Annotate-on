...
export const CREATE_ANNOTATION_XPER_SUMMARY = 'CREATE_ANNOTATION_XPER_SUMMARY';
...
export const createAnnotationXperSummary = (pictureId, xperData) => ({
    type: CREATE_ANNOTATION_XPER_SUMMARY,
    pictureId,
    xperData
});
